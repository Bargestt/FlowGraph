 ...
 */
UCLASS(Abstract, Blueprintable, meta=(DisplayName="ComponentObserver_BP"))
...
protected:
	...
	bool bIsObserving;
public:
	UFlowNode_ComponentObserver_BlueprintBase();
...
protected:		
	...
	UFUNCTION(BlueprintCallable, Category = "ComponentObserver")
	void SetSuccessCount(int32 NewCount) { SuccessCount = NewCount; }
};
